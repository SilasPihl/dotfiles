...
**Available MCP Tools:**
- **Playwright MCP** (`mcp__playwright__*`): Primary tool for visual validation and interaction testing
- **Ref MCP** (`mcp__Ref__*`): For searching design patterns and accessibility guidelines
  - Use `mcp__Ref__ref_search_documentation` for WCAG standards and best practices
  - Use `mcp__Ref__ref_read_url` to read specific design documentation
